...
This document defines how AI assistants (Claude Code and similar) should behave when working in this repository. It is the authoritative source for working rules — `CLAUDE.md` is a summary that points here for detail.
